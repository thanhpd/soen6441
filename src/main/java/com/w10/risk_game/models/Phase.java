...
public abstract class Phase {
	 ...
	 * @param p_bonus
	 *                        The p_bonus parameter represents the bonus value
	 *                        associated with
	 *                        the continent.
	 */
	 ...
	 *
	 * @param p_countryId
	 *                    The parameter "p_countryId" is the unique identifier of
	 *                    the
	 ...
	 * @param p_mapType
	 *                      The type of the map to save. 1 for Domination, 2 for
	 *                      Conquest.
	 */
