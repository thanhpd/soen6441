...
public class App {
	 ...
	 * The code is the main method of the application. It initializes a GameEngine
	 * object and starts a loop that prompts the user for input and performs different actions based on
	 * the input.
	 */
