...
public class AttackPhase extends MainPlayPhase {

	public AttackPhase(GameEngine p_GameEngine) {
		super(p_GameEngine);
	}
	...
	@Override
	public void next() {
		d_gameEngine.setPhase(new FortificationPhase(d_gameEngine));
	}

	@Override
	public Set<Command> getAvailableCommands() {
		return Set.of(Command.ADVANCE, Command.BOMB, Command.SHOW_MAP);
	}
