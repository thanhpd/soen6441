...
public enum Command {
	...
	NEXT(Constants.USER_INPUT_COMMAND_OPTION_NEXT), 
	EDIT_COUNTRY(Constants.USER_INPUT_COMMAND_EDIT_COUNTRY), 
	EDIT_NEIGHBOR(Constants.USER_INPUT_COMMAND_EDIT_NEIGHBOR), 
	GAME_PLAYER_REMOVE(Constants.CLI_GAME_PLAYER_REMOVE), 
	GAME_PLAYER_CREATE(Constants.CLI_GAME_PLAYER_CREATE), 
	ASSIGN_COUNTRIES(Constants.CLI_ASSIGN_COUNTRIES);
