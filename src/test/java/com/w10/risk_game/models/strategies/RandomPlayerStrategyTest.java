...
public class RandomPlayerStrategyTest {
    ...
    public void setup(){
        ...
        d_player1 = new Player("RandomPlayer1", new ArrayList<Country>(), null, 10, new RandomPlayerStrategy(d_player1));
        d_player2 = new Player("RandomPlayer2", new ArrayList<Country>(), null, 15, new RandomPlayerStrategy(d_player2));
