...
public class MapReader {
    ...
    /**
     * 
     * @param takes scanner of the file reads untill Continent, Borders or empty
     *              line found
     *              Put it in a hashmap
    ...
    /**
     * @param takes scanner and read untill continents, countries and empty line
     *              found
    ...
    /**
     * 
     * @param takes scanner of the file reads untill Country, Borders or empty line
     *              found
     *              Put it in a hashmap
    ...
    /**
     * 
     * @param calls from readCountry method for each line of the country
     *              splits the line and set it to the country object
    ...
    /**
     * 
     * @param calls from readContinent method for each line of the continents
     *              splits the line and set it to the country object
     ...
     * Example: europe.map
     * 
     * @throws file not found expection
     * @param mapFilename
