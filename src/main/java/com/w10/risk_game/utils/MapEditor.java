...
/**
 * @author Omnia Alam
 * This class is the map editor service class. 
 * It adds removes countries continents and neighbour countries based on the user inputs
 * While doing that it validates if the user inputs are valid or not
 * If valid then perform the command
 * if not valid then returns an error message
 */
...
// The `MapEditor` class has a constructor that takes a `GameMap` object as a parameter. The purpose of
// this constructor is to initialize the `l_gameMap` instance variable of the `MapEditor` class with
// the provided `originalMap` object. This allows the `MapEditor` class to access and modify the game
// map data.
	...
	/**
	 * The function adds a country to a game map if it meets certain conditions, such as having a unique
	 * name and ID, and belonging to an existing continent.
	 * 
	 * @param p_countryId The unique identifier for the country.
	 * @param p_countryName The name of the country that you want to add.
	 * @param p_continentName The parameter p_continentName is a String that represents the name of the
	 * continent to which the country belongs.
	 * @return The method returns a string message. The message can be one of the following:
	 * - "Country Name is empty!" if the p_countryName parameter is blank.
	 * - "Continent Name is empty!" if the p_continentName parameter is blank.
	 * - "Country name already exists!" if the l_gameMap already contains a country with the same name as
	 * p_countryName.
	 * - "Country ID already
	 */
...
/**
 * The function adds a new continent to the game map if the continent name and id do not already exist.
 * 
 * @param p_continentId The continent ID is an integer value that uniquely identifies a continent.
 * @param p_continentName The name of the continent that you want to add.
 ...
 */
	 ...
	 * 
	 * @param p_countryId The ID of the country to which you want to add a neighbor.
	 * @param p_neighborCountryId The ID of the country that you want to add as a neighbor to the country
	 * with ID p_countryId.
	 * @return The method is returning a string that indicates the result of adding a neighbor country to
	 * a given country.
	 */
	...
	/**
	 * The function removes a country from a game map and updates the neighboring countries accordingly.
	 * 
	 * @param p_countryId The parameter p_countryId is an integer representing the ID of the country that
	 * needs to be removed.
	 * @return The method is returning a string.
	 */
...
/**
 * The function removes a continent and all its associated countries from a game map.
 * 
 * @param p_continentId The parameter p_continentId is an integer that represents the ID of the
 * continent that needs to be removed.
 * @return The method is returning a string.
 */
...
/**
 * The function removes a neighbor connection between two countries in a game map.
 * 
 * @param p_countryId The ID of the country from which you want to remove a neighbor.
 * @param p_neighborCountryId The ID of the neighbor country that you want to remove the connection
 * with.
 * @return The method is returning a string.
 */
